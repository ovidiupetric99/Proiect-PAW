...
@section('content')
    <div id="admin-content">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <h2 class="admin-heading">Toti autorii</h2>
                </div>
                <div class="offset-md-7 col-md-2">
                    <a class="add-new" href="{{ route('authors.create') }}">Adauga autor</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                        ...
                        <tbody>
                            @forelse ($authors as $auther)
                                <tr>
                                    ...
                                    <td>{{ $auther->name }}</td>
                                    <td class="edit">
                                        <a href="{{ route('authors.edit', $auther) }}"style="background-color:#28A745" class="btn btn-success">Edit</a>
                                    </td>
                                    <td class="delete">
