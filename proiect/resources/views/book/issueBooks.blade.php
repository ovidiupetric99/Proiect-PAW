...
@section('content')
    <div id="admin-content">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <h2 class="admin-heading">Toate imprumuturile</h2>
                </div>
                <div class="offset-md-6 col-md-3">
                    <a class="add-new" href="{{ route('book_issue.create') }}">Adauga imprumut</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                            ...
                            @forelse ($books as $book)
                                <tr style='@if (date('Y-m-d') > $book->return_date->format('d-m-Y') && $book->issue_status == 'N') ) background:rgba(255,0,0,0.2) @endif'>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class='badge badge-danger'>Imprumutat</span>
                                        @endif
                                    </td>
                                    <td class="edit">
